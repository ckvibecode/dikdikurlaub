...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="sticky bottom-0 z-10 mx-auto flex w-full max-w-md items-center justify-around border-t border-white/[0.06] bg-[#0e1015] px-2 pb-[calc(env(safe-area-inset-bottom)+10px)] pt-2"
    >
          ...
          >
            <span
              className={`flex h-7 w-8 items-center justify-center ${
                active ? 'rounded-blob bg-member/16 text-member' : 'rounded-full text-muted-3'
              }`}
            >
